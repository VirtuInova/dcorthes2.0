...
export function Container (){
    return (
    <div className="w-full min-h-[100vh] bg-[white] px-[17%]" style={{alignItems:"center"}}>
        {Content()}
        {Selection()}
    </div>)
} 
    ...
    return (
        <div className="flex pt-[5vw] ">
            <div className="w-[70%] flex-col justify-between max-[425px]:w-full"> 
                <h5 className="text-left text-[3rem] mb-[4vw] max-[425px]:text-[8vw]">Nossos Produtos</h5>
            ...
            <div className={`flex justify-center ml-[2vw] w-[30rem] max-[425px]:w-[0vw] max-[425px]:h-[0vw]`}  style={{alignItems:"center"}}>
...
const responsive = {
  ...
  function Products(lista: Lista[]){
    return (
        <div className="w-[100%] mt-[2vw] pb-[2vw] h-[20rem] max-[425px]:h-[40vw] flex items-center">
            <Carousel autoPlay={true} infinite={true}  removeArrowOnDeviceType={["tablet", "mobile"]} responsive={responsive} className="w-full h-full">
                {
                    lista.map((index) => (
                        <div key={index.nome} className="w-[50%]">
                            <div className="h-[8rem] w-[8rem] max-[425px]:h-[30vw] max-[425px]:w-[37vw]  overflow-hidden">
                            ...
                            <div className="w-[8rem] max-[425px]:w-[37vw] max-[425px]:h-[6vw] rounded-[2vw] mt-[1vw] bg-black p-[0.4vw] flex justify-center items-center"><h1 className="max-[425px]:text-[3vw]">{index.nome}</h1></div>
                        </div>
                    ))
                }
            </Carousel>
